...
def make_your_own
    ...
    until selection_1 == 6 do
        ...
        table = Terminal::Table.new do |t|
            ...
            t.add_row []
            t.style = {:width => 130, :padding_left => 4}
        end
        puts table
    ...
    #{"----------------------------------------------------------".colorize(:red)}
        ...
        if selection_1 == 1 # Insert basic element
            ...
            if selection_2 <= output.count && selection_2 > 0
                ...
                terminal_code.delete_at(selection_2-1)
            elsif selection_2 == "x"
                puts ">" * 20
            else
                puts "Invalid selection. Please reselect!"
            ...
            puts " "
            0.upto(2) do
                STDOUT.print "\rC-Promptz™️ is baking...!"
                sleep 0.4
            ...
            puts table
            puts " " 
            puts "To see your brand new C-Promptz™ simply do one of the below:"
            puts "(1) Copy and paste 'source ~/.bash_profile' into your terminal"
            puts "(2) Re-open your terminal"                 
                             
            sleep 2
        end

        puts " "
        puts "Thanks for using C-Promptz™ - your most trusted Promptz Builder!"
        puts " "
        else
            puts "Invalid selection. Please reselect!"
            puts " "
